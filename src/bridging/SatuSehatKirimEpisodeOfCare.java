/*
  By Ikhsan Saputra RS Tk.III dr. REKSODIWIRYO
 */
package bridging;
 ...
 * @author dosen
 */
public final class SatuSehatKirimEpisodeOfCare extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public SatuSehatKirimEpisodeOfCare(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pengiriman Data Episode Of Care / Episode Kehamilan Awal ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            bw.write(LoadHTML.getText().replaceAll("<head>", "<head>"
                    ...
                    + "<font size='2' face='Arial'>DATA PENGIRIMAN SATU SEHAT EPISODE OF CARE<br><br></font>"
                    + "</td>"
                    + "</tr>"
                    + "</table>")
            );
...
//            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,5).toString().equals(""))&&(!tbObat.getValueAt(i,11).toString().equals(""))&&(!tbObat.getValueAt(i,13).toString().equals(""))&&tbObat.getValueAt(i,16).toString().equals("")){
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatKirimEpisodeOfCare dialog = new SatuSehatKirimEpisodeOfCare(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try {
            ...
            // Add conditions based on cmbStatus selection
            if (cmbStatus.getSelectedItem().toString().equals("Terkirim")) {
                queryRalan += " and satu_sehat_episode_of_care.id_episode_of_care IS NOT NULL";
                queryRanap += " and satu_sehat_episode_of_care.id_episode_of_care IS NOT NULL";
            }

            if (cmbStatus.getSelectedItem().toString().equals("Belum Terkirim")) {
                queryRalan += " and satu_sehat_episode_of_care.id_episode_of_care IS NULL";
