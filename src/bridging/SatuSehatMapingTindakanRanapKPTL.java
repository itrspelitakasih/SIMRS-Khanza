 ...
 * @author dosen
 */
public final class SatuSehatMapingTindakanRanapKPTL extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatMapingTindakanRanapKPTL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Tarif Tindakan Rawat Inap KPTL Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void btnBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarangActionPerformed
        DlgJnsPerawatanRanap pemeriksaan=new DlgJnsPerawatanRanap(null,false);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("satu_sehat_mapping_tindakanranap_kptl","?,?,?,?","Mapping Tindakan Rawat Jalan",4,new String[]{
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,KodeTindakan,"satu_sehat_mapping_tindakanranap_kptl","kd_jenis_prw")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("satu_sehat_mapping_tindakanranap_kptl","kd_jenis_prw=?","kd_jenis_prw=?,code=?,system=?,display=?",5,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatMapingTindakanRanapKPTL dialog = new SatuSehatMapingTindakanRanapKPTL(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select satu_sehat_mapping_tindakanranap_kptl.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,satu_sehat_mapping_tindakanranap_kptl.code,satu_sehat_mapping_tindakanranap_kptl.system,"+
                   "satu_sehat_mapping_tindakanranap_kptl.display from satu_sehat_mapping_tindakanranap_kptl inner join jns_perawatan_inap on satu_sehat_mapping_tindakanranap_kptl.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "+
                   (TCari.getText().equals("")?"":"where satu_sehat_mapping_tindakanranap_kptl.kd_jenis_prw like ? or jns_perawatan_inap.nm_perawatan like ? or "+
                   "satu_sehat_mapping_tindakanranap_kptl.code like ? or satu_sehat_mapping_tindakanranap_kptl.display like ? ")+
                   " order by satu_sehat_mapping_tindakanranap_kptl.code");
            try {
