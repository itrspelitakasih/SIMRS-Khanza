                    ...
                    try{
                        ...
                        json = "{" +
                                    ...
                                    "\"basedOn\": [" +
                                        ...
                                        "}" +
                                    "]," +
                                    "\"conclusion\": \""+jsonEscape(tbObat.getValueAt(i,21).toString().replaceAll("(\r\n|\r|\n|\n\r)","<br>").replaceAll("\t", " "))+"\"" +
                                "}";
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   (CmbStatus.getSelectedItem().toString().equals("Belum Terkirim") ? " and ifnull(satu_sehat_diagnosticreport_lab_mb.id_diagnosticreport,'') = ''" : "") +
                   (CmbStatus.getSelectedItem().toString().equals("Sudah Terkirim") ? " and ifnull(satu_sehat_diagnosticreport_lab_mb.id_diagnosticreport,'') != ''" : ""));
            try {
