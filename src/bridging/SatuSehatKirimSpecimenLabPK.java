            ...
            if(tbObat.getValueAt(i,0).toString().equals("true")&&(!tbObat.getValueAt(i,4).toString().equals(""))&&tbObat.getValueAt(i,13).toString().equals("")){
                try {
                    ...
                    try{
                        ...
                        String sampelDT = tbObat.getValueAt(i,6).toString().replaceAll(" ","T")+"+07:00";
                        json = "{" +
                                    ...
                                    "]," +
                                    "\"collection\": {" +
                                        "\"collectedDateTime\": \""+sampelDT+"\"" +
                                    "}," +
                                    "\"receivedTime\": \""+sampelDT+"\"" +
                                "}";
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                   ...
                   (CmbStatus.getSelectedItem().toString().equals("Belum Terkirim") ? " and ifnull(satu_sehat_specimen_lab.id_specimen,'') = ''" : "") +
                   (CmbStatus.getSelectedItem().toString().equals("Sudah Terkirim") ? " and ifnull(satu_sehat_specimen_lab.id_specimen,'') != ''" : ""));
            try {
