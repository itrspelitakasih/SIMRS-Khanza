...
public class OrthancDICOM extends javax.swing.JDialog {
    ...
    private String tglPeriksa = "", jamPeriksa = ""; // tambah ini
    ...
    private void BtnJpgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnJpgActionPerformed
        String norawatslash = norawat.substring(0, 4) + "/"
                + norawat.substring(4, 6) + "/"
                + norawat.substring(6, 8) + "/"
                + norawat.substring(8);

        // Gunakan tglPeriksa dan jamPeriksa dari setJudul jika tersedia
        // fallback ke waktu sekarang jika kosong (untuk form lain yang tidak set
        // tgl/jam)
        String tgl = (tglPeriksa != null && !tglPeriksa.isEmpty())
                ? tglPeriksa
                : new java.text.SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date());
        String jam = (jamPeriksa != null && !jamPeriksa.isEmpty())
                ? jamPeriksa
                : new java.text.SimpleDateFormat("HH:mm:ss").format(new java.util.Date());

        System.out.println("=== DEBUG BtnJpg ===");
        System.out.println("norawat      : " + norawat);
        System.out.println("norawatslash : " + norawatslash);
        System.out.println("tglPeriksa   : " + tgl);
        System.out.println("jamPeriksa   : " + jam);
        System.out.println("===================");

        orthanc.AmbilJpg(norawat, series, norawatslash, tgl, jam);
    ...
    private void BtnSimpan4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan4ActionPerformed
        if (AccessionNumber.getText().trim().equals("")) {
            ...
            if (!orthanc.UbahAccession(study, AccessionNumber.getText()).equals("")) {
