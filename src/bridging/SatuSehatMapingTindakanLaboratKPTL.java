 ...
 * @author dosen
 */
public final class SatuSehatMapingTindakanLaboratKPTL extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SatuSehatMapingTindakanLaboratKPTL(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Tarif Tindakan Laboratorium KPTL Satu Sehat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(660, 95));
    ...
    private void btnBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarangActionPerformed
        DlgJnsPerawatanLab pemeriksaan=new DlgJnsPerawatanLab(null,false);
    ...
    private void btnBarangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnBarangKeyPressed
        Valid.pindah(evt, TindakanSystem, Display);
}//GEN-LAST:event_btnBarangKeyPressed

    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Code.getText().trim().equals("")){
            Valid.textKosong(Code,"Tindakan Code");
        }else if(TindakanSystem.getText().trim().equals("")){
            Valid.textKosong(TindakanSystem,"System");
            ...
            if(Sequel.menyimpantf("satu_sehat_mapping_tindakanlab_kptl","?,?,?,?","Mapping Tindakan Rawat Jalan",4,new String[]{
                KodeTindakan.getText(),Code.getText(),TindakanSystem.getText(),Display.getText()
            })==true){
                tabMode.addRow(new Object[]{
                    Code.getText(),TindakanSystem.getText(),KodeTindakan.getText(),NamaTindakan.getText(),Display.getText()
                });
                emptTeks();
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Valid.hapusTabletf(tabMode,KodeTindakan,"satu_sehat_mapping_tindakanlab_kptl","kd_jenis_prw")==true){
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Code.getText().trim().equals("")){
            ...
            if(tbJnsPerawatan.getSelectedRow()>-1){
                if(Sequel.mengedittf("satu_sehat_mapping_tindakanlab_kptl","kd_jenis_prw=?","kd_jenis_prw=?,code=?,system=?,display=?",5,new String[]{
                    ...
                    tabMode.setValueAt(TindakanSystem.getText(),tbJnsPerawatan.getSelectedRow(),1);
                    tabMode.setValueAt(KodeTindakan.getText(),tbJnsPerawatan.getSelectedRow(),2);
                    tabMode.setValueAt(NamaTindakan.getText(),tbJnsPerawatan.getSelectedRow(),3);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReport("rptMapingTindakanLabKPTLSatuSehat.jasper","report","::[ Mapping Tindakan Laboratorium KPTL Satu Sehat Kemenkes ]::",param);            
        }
    ...
    private void btnBarang1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBarang1ActionPerformed
        SatuSehatReferensiKPTL referensi=new SatuSehatReferensiKPTL(null,false);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SatuSehatMapingTindakanLaboratKPTL dialog = new SatuSehatMapingTindakanLaboratKPTL(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox KodeTindakan;
    private widget.Label LCount;
    private widget.TextBox NamaTindakan;
    private javax.swing.JPanel PanelInput;
    private widget.ScrollPane Scroll;
    private widget.TextBox TCari;
    private widget.TextBox TindakanSystem;
    ...
    private void tampil() {
        ...
        try{
           ps=koneksi.prepareStatement(
                   "select satu_sehat_mapping_tindakanlab_kptl.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,satu_sehat_mapping_tindakanlab_kptl.code,satu_sehat_mapping_tindakanlab_kptl.system,"+
                   "satu_sehat_mapping_tindakanlab_kptl.display from satu_sehat_mapping_tindakanlab_kptl inner join jns_perawatan_lab on satu_sehat_mapping_tindakanlab_kptl.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw "+
                   (TCari.getText().equals("")?"":"where satu_sehat_mapping_tindakanlab_kptl.kd_jenis_prw like ? or jns_perawatan_lab.nm_perawatan like ? or "+
                   "satu_sehat_mapping_tindakanlab_kptl.code like ? or satu_sehat_mapping_tindakanlab_kptl.display like ? ")+
                   " order by satu_sehat_mapping_tindakanlab_kptl.code");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        rs.getString("code"),rs.getString("system"),rs.getString("kd_jenis_prw"),rs.getString("nm_perawatan"),rs.getString("display")
                    });
                }
            } catch (Exception e) {
    ...
    public void emptTeks() {
        Code.setText("");
        TindakanSystem.setText("");
        KodeTindakan.setText("");
    ...
    private void getData() {
       if(tbJnsPerawatan.getSelectedRow()!= -1){
           ...
           TindakanSystem.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),1).toString());
           KodeTindakan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),2).toString());
           NamaTindakan.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),3).toString());
           Display.setText(tbJnsPerawatan.getValueAt(tbJnsPerawatan.getSelectedRow(),4).toString());
        }
    }
    
    public void isCek(){
        BtnSimpan.setEnabled(akses.getsatu_sehat_mapping_kptl_tindakan_laborat());
        BtnHapus.setEnabled(akses.getsatu_sehat_mapping_kptl_tindakan_laborat());
        BtnEdit.setEnabled(akses.getsatu_sehat_mapping_kptl_tindakan_laborat());
        BtnPrint.setEnabled(akses.getsatu_sehat_mapping_kptl_tindakan_laborat());
    }
