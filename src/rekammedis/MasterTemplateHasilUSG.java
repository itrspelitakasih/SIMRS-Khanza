...
public class MasterTemplateHasilUSG extends javax.swing.JDialog {
    ...
    public MasterTemplateHasilUSG(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Kd.setDocument(new batasInput((byte)10).getKata(Kd));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Master Template Hasil Pemeriksaan USG ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50)));
        ...
        jLabel40.setText("Template Hasil Pemeriksaan USG :");
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {
        if(Kd.getText().trim().equals("")){
            ...
            Valid.textKosong(Template,"Template Hasil USG");
        }else{
    ...
    private void NmKeyPressed(java.awt.event.KeyEvent evt) {
        Valid.pindah(evt,Kd,Template);
    }

    private void TemplateKeyPressed(java.awt.event.KeyEvent evt) {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            MasterTemplateHasilUSG dialog = new MasterTemplateHasilUSG(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "where template_hasil_radiologi.no_template like 'USG%' and (template_hasil_radiologi.no_template like ? or template_hasil_radiologi.nama_pemeriksaan like ? or "+
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Template.setText("");
        Valid.autoNomer("template_hasil_radiologi","USG",4,Kd);
        TabRawat.setSelectedIndex(0);
        Kd.requestFocus();
    }
