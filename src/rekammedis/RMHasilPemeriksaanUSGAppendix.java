...
import rekammedis.MasterCariTemplateHasilUSG;
 ...
 * @author perpustakaan
 */
public final class RMHasilPemeriksaanUSGAppendix extends javax.swing.JDialog {
    ...
    private MasterCariTemplateHasilUSG templatehasil=new MasterCariTemplateHasilUSG(null,false);
     ...
     * @param parent
     * @param modal */
    public RMHasilPemeriksaanUSGAppendix(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","Kode Dokter","Nama Dokter","Tanggal","Kiriman Dari","Diagnosa Klinis","Hasil","Kesimpulan"
            }){
        ...
        Hasil.setDocument(new batasInput((int)200).getKata(Hasil));
        ...
        templatehasil.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if(akses.getform().equals("RMHasilPemeriksaanUSGAppendix")){
                    if(templatehasil.getTable().getSelectedRow()!= -1){                   
                        Hasil.setText(templatehasil.getTable().getValueAt(templatehasil.getTable().getSelectedRow(),2).toString());
                    } 
                    Hasil.requestFocus();
                }
            }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan USG Appendix ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-02-2025 23:05:08" }));
        ...
        scrollPane18.setViewportView(Hasil);

        FormInput.add(scrollPane18);
        scrollPane18.setBounds(89, 110, 635, 170);

        jLabel48.setText("Kesimpulan :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 290, 85, 23);
        ...
        scrollPane21.setBounds(90, 290, 635, 160);
        ...
        btnAmbilPhoto.setBounds(0, 180, 90, 20);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-02-2025" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-02-2025" }));
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>"+
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>Hasil</b></td>"+
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("photo","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanusgappendix/"+lokasifile);
            param.put("umurdaftar",Sequel.cariIsi("select umurdaftar from reg_periksa where no_rawat=?",TNoRw.getText()));
            param.put("sttsumur",Sequel.cariIsi("select sttsumur from reg_periksa where no_rawat=?",TNoRw.getText()));
            param.put("alamat",Sequel.cariIsi("select alamat from pasien where no_rkm_medis=?",TNoRM.getText()));
            param.put("tanggal",Sequel.cariIsi("select tanggal from hasil_pemeriksaan_usg_appendix where no_rawat=?",TNoRw.getText()));
            Valid.MyReportqry("rptCetakHasilPemeriksaanUSGAppendix.jasper","report","::[ Formulir Hasil Pemeriksaan USG ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_usg_appendix.tanggal,"+
                "hasil_pemeriksaan_usg_appendix.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_usg_appendix.diagnosa_klinis,hasil_pemeriksaan_usg_appendix.kiriman_dari,"+
                "hasil_pemeriksaan_usg_appendix.hasil,"+
                "hasil_pemeriksaan_usg_appendix.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join hasil_pemeriksaan_usg_appendix on reg_periksa.no_rawat=hasil_pemeriksaan_usg_appendix.no_rawat "+
                "inner join dokter on hasil_pemeriksaan_usg_appendix.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_usg_appendix.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void DiagnosaKlinisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKlinisKeyPressed
        Valid.pindah(evt,KirimanDari,Hasil);
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                Valid.panggilUrl("hasilpemeriksaanusgappendix/login.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&no_rawat="+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString());
                this.setCursor(Cursor.getDefaultCursor()); 
            }else{
...
//        Valid.pindah2(evt,Doppler,BtnSimpan);
    ...
    private void btnAmbilPhotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilPhotoActionPerformed
        akses.setform("RMHasilPemeriksaanUSGAppendix");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilPemeriksaanUSGAppendix dialog = new RMHasilPemeriksaanUSGAppendix(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "hasil_pemeriksaan_usg_appendix.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join hasil_pemeriksaan_usg_appendix on reg_periksa.no_rawat=hasil_pemeriksaan_usg_appendix.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_usg_appendix.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_usg_appendix.tanggal between ? and ? order by hasil_pemeriksaan_usg_appendix.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_usg_appendix.tanggal,"+
                        "hasil_pemeriksaan_usg_appendix.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_usg_appendix.diagnosa_klinis,hasil_pemeriksaan_usg_appendix.kiriman_dari,"+
                        ...
                        "inner join hasil_pemeriksaan_usg_appendix on reg_periksa.no_rawat=hasil_pemeriksaan_usg_appendix.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_usg_appendix.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_usg_appendix.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "hasil_pemeriksaan_usg_appendix.kd_dokter like ? or dokter.nm_dokter like ?) order by hasil_pemeriksaan_usg_appendix.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kiriman_dari"),rs.getString("diagnosa_klinis"),rs.getString("hasil"),rs.getString("kesimpulan")
                    });
                }
            } catch (Exception e) {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from hasil_pemeriksaan_usg_appendix where no_rawat=?",1,new String[]{
...
//    private void ganti() {
//        if(Sequel.mengedittf("hasil_pemeriksaan_usg_appendix","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,kiriman_dari=?,hasil=?,kesimpulan=?",8,new String[]{
...
//                KirimanDari.getText(),DiagnosaKlinis.getText(),Hasil.getText(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
//            })==true){
...
//                tbObat.setValueAt(Hasil.getText(),tbObat.getSelectedRow(),9);
//                tbObat.setValueAt(Kesimpulan.getText(),tbObat.getSelectedRow(),10);
//                emptTeks();
//                TabRawat.setSelectedIndex(1);
//        }
//    }
    ...
    System.out.println("no_rawat yang digunakan untuk update: " + noRawat);
    
    String tanggalKirim = Valid.SetTgl(Tanggal.getSelectedItem() + "") + " " + Tanggal.getSelectedItem().toString().substring(11, 19);
    System.out.println("Tanggal yang dikirim: " + tanggalKirim);
    
    System.out.println("Kode Dokter: " + KdDokter.getText());
    System.out.println("Diagnosa Klinis: " + DiagnosaKlinis.getText());

    // SQL update query
    String sql = "UPDATE hasil_pemeriksaan_usg_appendix SET no_rawat=?, tanggal=?, kd_dokter=?, diagnosa_klinis=?, kiriman_dari=?, hasil=?, kesimpulan=? WHERE no_rawat=?";
    
    try {
        PreparedStatement ps = koneksi.prepareStatement(sql);
        ps.setString(1, TNoRw.getText());
        ps.setString(2, tanggalKirim);
        ps.setString(3, KdDokter.getText());
        ps.setString(4, DiagnosaKlinis.getText());
        ps.setString(5, KirimanDari.getText());
        ps.setString(6, Hasil.getText());
        ps.setString(7, Kesimpulan.getText());
        ps.setString(8, noRawat); // Where condition
        
        int rowsUpdated = ps.executeUpdate();
        System.out.println("Baris yang diperbarui: " + rowsUpdated);
        ...
        if (rowsUpdated > 0) {
            ...
            tbObat.setValueAt(KdDokter.getText(), tbObat.getSelectedRow(), 4);
            tbObat.setValueAt(NmDokter.getText(), tbObat.getSelectedRow(), 5);
            tbObat.setValueAt(tanggalKirim, tbObat.getSelectedRow(), 6);
            tbObat.setValueAt(KirimanDari.getText(), tbObat.getSelectedRow(), 7);
            tbObat.setValueAt(DiagnosaKlinis.getText(), tbObat.getSelectedRow(), 8);
            tbObat.setValueAt(Hasil.getText(), tbObat.getSelectedRow(), 9);
            tbObat.setValueAt(Kesimpulan.getText(), tbObat.getSelectedRow(), 10);
            ...
            System.out.println("Update gagal! Mungkin no_rawat tidak ditemukan.");
        }
    ...
    private void panggilPhoto() {
        if(FormPhoto.isVisible()==true){
            lokasifile="";
            try {
                ps=koneksi.prepareStatement("select hasil_pemeriksaan_usg_appendix_gambar.photo from hasil_pemeriksaan_usg_appendix_gambar where hasil_pemeriksaan_usg_appendix_gambar.no_rawat=?");
                try {
                    ...
                    if(rs.next()){
                        if(rs.getString("photo").equals("")||rs.getString("photo").equals("-")){
                            ...
                            LoadHTML2.setText("<html><body><center><a href='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanusgappendix/"+rs.getString("photo")+"'><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanusgappendix/"+rs.getString("photo")+"' alt='photo' width='550' height='550'/></a></center></body></html>");
                        }  
                    }else{
                        lokasifile="";
                        LoadHTML2.setText("<html><body><center><br><br><font face='Arial' size='2' color='#434343'>Kosong</font></center></body></html>");
    ...
    private void simpan() {
        if(Sequel.menyimpantf("hasil_pemeriksaan_usg_appendix","?,?,?,?,?,?,?","No.Rawat",7,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),KirimanDari.getText(),Hasil.getText(),Kesimpulan.getText()
            })==true){
                tabMode.addRow(new String[]{
                    TNoRw.getText(),TNoRM.getText(),TPasien.getText(),TglLahir.getText(),KdDokter.getText(),NmDokter.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),
                    KirimanDari.getText(),DiagnosaKlinis.getText(),Hasil.getText(),Kesimpulan.getText()
                });
                emptTeks();
                LCount.setText(""+tabMode.getRowCount());
        }
