...
public class DlgRiwayatBatch extends javax.swing.JDialog {
    ...
    public DlgRiwayatBatch(java.awt.Frame parent, boolean modal) {
        ...
        styleSheet.addRule(
                ...
                ".head td{border-right: 1px solid #777777;font: 8.5px Arial;height:9px;border-bottom: 1px solid #e2e7dd;background: #ffffff;color:#323232;}"+
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Riwayat Data Batch Obat ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
                                ...
                                "<table width='1400px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Arial'>DATA RIWAYAT BATCH<br>PERIODE BARANG DATANG "+Tgl1.getSelectedItem()+" s.d. "+Tgl2.getSelectedItem()+"<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
