...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-04-2026 11:29:43" }));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Permintaan Laboratorium Patologi Klinis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnAmbilLIS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/36.png"))); // NOI18N
        BtnAmbilLIS.setText("Ambil LIS");
        BtnAmbilLIS.setName("BtnAmbilLIS"); // NOI18N
        BtnAmbilLIS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAmbilLISActionPerformed(evt);
            }
        });
        panelisi1.add(BtnAmbilLIS);
        ...
        BtnKirimLica.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLica.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimSysmex.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilSysmex.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISELIMS.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISELIMS.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISTeras.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISTeras.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISMADQLAB.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISMADQLAB.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISSMARTLAB.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISSMARTLAB.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISSOFTMEDIX.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISSOFTMEDIX.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimVansLab.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilVanslab.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnKirimLISSLIMS.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        BtnAmbilLISSLIMS.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
...
private void tbLabRalanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbLabRalanKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void BtnAmbilLISActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAmbilLISActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                        ...
                        if(Sampel.equals("")){
                            ...
                            dlgro.emptTeks();
                            dlgro.isCek();
                            dlgro.setOrderLISYPM(NoPermintaan,NoRawat,"Ralan");
                            dlgro.setDokterPerujuk(KodeDokter,DokterPerujuk);
                            TeksKosong();
                            dlgro.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
                ...
                if(!NoRawat.equals("")){
                    if(NoPermintaan.trim().equals("")||DiagnosaKlinis.trim().equals("")){
                        ...
                        if(Sampel.equals("")){
                            ...
                            dlgro.emptTeks();
                            dlgro.isCek();
                            dlgro.setOrderLISYPM(NoPermintaan,NoRawat,"Ranap");
                            dlgro.setDokterPerujuk(KodeDokter,DokterPerujuk);
                            TeksKosong();
                            dlgro.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
    ...
    }//GEN-LAST:event_BtnAmbilLISActionPerformed
    ...
    */
    ...
    private widget.Button BtnAmbilLIS;
                ...
                if (NoPermintaan.trim().equals("") || DiagnosaKlinis.trim().equals("")) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            rs = ps.executeQuery();
                            if (rs.next()) {
                                koneksilisypm.prepareStatement(
                                        "insert into permintaan_lab values('" + rs.getString("noorder") + "','" + rs.getString("no_rawat") + "','" + rs.getString("no_rkm_medis") + "',"
                                        + "'" + rs.getString("nm_pasien") + "','" + rs.getString("email") + "','" + rs.getString("jk") + "','" + rs.getString("tmp_lahir") + "','" + rs.getString("tgl_lahir") + "',"
                                        + "'" + rs.getString("alamat") + ", " + rs.getString("nm_kel") + ", " + rs.getString("nm_kec") + ", " + rs.getString("nm_kab") + ", " + rs.getString("nm_prop") + "',"
                                        + "'" + rs.getString("tgl_permintaan") + "','" + rs.getString("jam_permintaan") + "','" + rs.getString("dokter_perujuk") + "','" + rs.getString("nm_dokter") + "',"
                                ...
                                try {
                                    ...
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksilisypm.prepareStatement("insert into detail_permintaan_lab values('" + rs2.getString("noorder") + "','" + rs2.getString("kd_jenis_prw") + "','" + rs2.getString("id_template") + "')").executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                                } finally {
                            ...
                            JOptionPane.showMessageDialog(null, "Kirim Ke LIS Berhasil.!!");
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(null, "Proses kirim gagal..!!" + e);
                            System.out.println("Notif : " + e);
                        } finally {
