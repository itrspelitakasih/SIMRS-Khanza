...
public final class InformasiTarifRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Informasi Tarif Tindakan Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            String query="select jns_perawatan_inap.kd_jenis_prw,jns_perawatan_inap.nm_perawatan,kategori_perawatan.nm_kategori,"+
            ...
            if(adaKelas){
                query+=" and jns_perawatan_inap.kelas=? ";
            }
            if(adaKdpj){
                query+=" and jns_perawatan_inap.kd_pj=? ";
            }
            query+="order by jns_perawatan_inap.kd_jenis_prw";
