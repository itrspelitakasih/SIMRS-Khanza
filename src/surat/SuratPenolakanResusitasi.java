 ...
 */
public final class SuratPenolakanResusitasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratPenolakanResusitasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Penolakan Resusitasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TabData.addTab("Bukti Pembuat Penolakan", Scroll5);
        ...
        TglPernyataan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-06-2026" }));
        ...
        jLabel100.setText("A. PEMBUAT PENOLAKAN");
        ...
        TanggalLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-06-2026" }));
                                        ...
                                        "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                            "<tr class='isi2'>"+
                                                "<td valign='top' align='center'>"+
                                                    ...
                                                    "<font size='2' face='Arial'>DATA SURAT PENOLAKAN RESUSITASI<br><br></font>"+        
                                                "</td>"+
                                           "</tr>"+
                                        "</table>")
                            );
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(lokasifile.equals("")){
                ...
                param.put("photo_penerima","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/penolakanresusitasi/"+lokasifile);
                param.put("photo_saksi","http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/penolakanresusitasi/"+lokasifile2);
                ...
                Valid.MyReportqry("rptSuratPenolakanResusitasi.jasper","report","::[ Surat Penolakan Resusitasi ]::",
    ...
    private void TabDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabDataMouseClicked
        if(TabData.getSelectedIndex()==0){
            if(lokasifile.equals("")){
                ...
                LoadHTML2.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/penolakanresusitasi/"+lokasifile+"' alt='photo' width='450' height='550'/></center></body></html>");
            } 
        }else{
            if(lokasifile2.equals("")){
                LoadHTML3.setText("<html><body><center><br><br><font face='Arial' size='2' color='#434343'>Kosong</font></center></body></html>");
            }else{
                LoadHTML3.setText("<html><body><center><img src='http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/penolakanresusitasi/"+lokasifile2+"' alt='photo' width='450' height='550'/></center></body></html>");
            } 
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratPenolakanResusitasi dialog = new SuratPenolakanResusitasi(new javax.swing.JFrame(), true);
