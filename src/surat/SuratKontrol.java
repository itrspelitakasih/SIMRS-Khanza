...
public class SuratKontrol extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnBatal.setPreferredSize(new java.awt.Dimension(40, 30));
        ...
        BtnHapus.setPreferredSize(new java.awt.Dimension(40, 30));
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2026" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2026" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2026 17:53:30" }));
        ...
        Status.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] { "Menunggu", "Sudah Periksa", "Batal Periksa" }));
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-07-2026 17:53:30" }));
        ...
        BtnCariData.setBounds(610, 10, 100, 30);

        jLabel19.setText("Tindakan 2 :");
        jLabel19.setName("jLabel19"); // NOI18N
        FormInput.add(jLabel19);
        jLabel19.setBounds(375, 100, 95, 23);
            ...
            if (akses.getkode().equals("Admin Utama")) {
                ...
                if (aktifjadwal.equals("aktif")) {
                    if (Sequel.cariInteger(
                            "select count(booking_registrasi.no_rkm_medis) from booking_registrasi where booking_registrasi.kd_dokter='"
                                    + KdDokter.getText() + "' and booking_registrasi.tanggal_periksa='"
                                    + Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + "' ") >= kuota) {
                ...
                dokter2.addWindowListener(new WindowListener() {
                    ...
                    public void windowClosed(WindowEvent e) {
                        if (dokter2.getTable().getSelectedRow() != -1) {
                            KdDokter.setText(
                                    dokter2.getTable().getValueAt(dokter2.getTable().getSelectedRow(), 0).toString());
                            NmDokter.setText(
                                    dokter2.getTable().getValueAt(dokter2.getTable().getSelectedRow(), 1).toString());
                            if (aktifjadwal.equals("aktif")) {
                                kuota = Integer.parseInt(dokter2.getTable()
                                        .getValueAt(dokter2.getTable().getSelectedRow(), 13).toString());
                            }
                            isNomer();
                        }
                    }
        ...
        if (TNoRM.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                if (Sequel.mengedittf("skdp_bpjs", "tahun=? and no_antrian=?",
                        ...
                        15, new String[] {
                                TanggalPeriksa.getSelectedItem().toString().substring(6, 10), TNoRM.getText(),
                                Diagnosa.getText(), Terapi.getText(),
                                Alasan1.getText(), Alasan2.getText(), Rtl1.getText(), Rtl2.getText(),
                                Valid.SetTgl(TanggalPeriksa.getSelectedItem() + ""),
                                Valid.SetTgl(TanggalSurat.getSelectedItem() + ""), NoSurat.getText(),
                                KdDokter.getText(), Status.getSelectedItem().toString(),
                                tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(),
                                tbObat.getValueAt(tbObat.getSelectedRow(), 11).toString()
                        }) == true) {
                    Sequel.mengedit3("booking_registrasi", "no_rkm_medis=? and tanggal_periksa=?",
                            "tanggal_booking=?,no_rkm_medis=?,tanggal_periksa=?,kd_dokter=?,kd_poli=?,no_reg=?", 8,
                            new String[] {
                                    Valid.SetTgl(TanggalSurat.getSelectedItem() + ""), TNoRM.getText(),
                                    Valid.SetTgl(TanggalPeriksa.getSelectedItem() + ""), KdDokter.getText(),
                                    KdPoli.getText(), NoReg.getText(),
                                    tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString(),
                                    tbObat.getValueAt(tbObat.getSelectedRow(), 9).toString()
                            });
                    tbObat.setValueAt(TanggalPeriksa.getSelectedItem().toString().substring(6, 10),
                            tbObat.getSelectedRow(), 0);
                ...
                poli2.addWindowListener(new WindowListener() {
                    ...
                    public void windowClosed(WindowEvent e) {
                        if (poli2.getTable().getSelectedRow() != -1) {
                            KdPoli.setText(
                                    poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(), 0).toString());
                            NmPoli.setText(
                                    poli2.getTable().getValueAt(poli2.getTable().getSelectedRow(), 1).toString());
                            isNomer();
                        }
                    }
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (tbObat.getSelectedRow() != -1) {
                ...
                param.put("sipdokter", Sequel.cariIsi(
                        "select dokter.no_ijn_praktek from dokter inner join skdp_bpjs on dokter.kd_dokter = skdp_bpjs.kd_dokter where skdp_bpjs.no_rkm_medis=?",
                        TNoRM.getText()));
                param.put("namars", akses.getnamars());
                param.put("alamatrs", akses.getalamatrs());
                param.put("kotars", akses.getkabupatenrs());
                ...
                param.put("alamat", alamat == null ? "" : alamat);
                // Formatter
                SimpleDateFormat inputFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");

                SimpleDateFormat tanggalIndoFormat = new SimpleDateFormat("dd MMMM yyyy", new Locale("id", "ID"));

                SimpleDateFormat jamFormat = new SimpleDateFormat("HH:mm");

                // ================================
                // TANGGAL PERIKSA KEMBALI
                // ================================
                Object objKembali = TanggalPeriksa.getSelectedItem();
                ...
                if (objKembali != null) {
                    try {
                        Date fullDate = inputFormat.parse(objKembali.toString().trim());

                        // HANYA tanggal Indonesia
                        tanggalKembali = tanggalIndoFormat.format(fullDate);

                        // Jam terpisah
                        jamKembali = jamFormat.format(fullDate);
                ...
                param.put("tanggal_kembali", tanggalKembali);
                param.put("jam_kembali", jamKembali);

                // ================================
                // TANGGAL SURAT
                // ================================
                Object objSurat = TanggalSurat.getSelectedItem();
                ...
                if (objSurat != null) {
                    try {
                        Date fullDate = inputFormat.parse(objSurat.toString().trim());

                        // HANYA tanggal Indonesia
                        tanggalSurat = tanggalIndoFormat.format(fullDate);

                        // Jam terpisah
                        jamSurat = jamFormat.format(fullDate);
                ...
                // (finger.equals("") ? tbObat.getValueAt(tbObat.getSelectedRow(),
                // 13).toString() : finger) + "\n" +
                // Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(), 10).toString()));
                param.put("finger", "https://apps.rspelitakasih.id/verifyPDF/?id="
                        + EnkripsiAES.encrypt("{'x':'lab','t':'" + TNoRM + "'}"));
                Sequel.queryu("delete from temporary_booking_registrasi");
                Sequel.menyimpan("temporary_booking_registrasi", "'0','"
                ...
                param.put("umur",
                        Sequel.cariIsi("select pasien.umur from pasien where no_rkm_medis=?", TNoRM.getText()));
                Valid.MyReport("rptSuratKontrolRSPK.jasper", "report", "::[ Surat Kontrol ]::", param);
                this.setCursor(Cursor.getDefaultCursor());
    ...
    private void BtnKirimGOWaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnKirimGOWaActionPerformed
        String[] pilihan = {
                "Kirim Surat Kontrol WA Tanpa Password",
                "Kirim Surat Kontrol WA Password",
                "Reminder Terjadwal",
                "Reminder Kirim Sekarang"
        };

        JComboBox<String> comboAksi = new JComboBox<>(pilihan);
        ...
        String aksi = comboAksi.getSelectedItem().toString();

        if (aksi.equals("Kirim Surat Kontrol WA Tanpa Password")) {
            runBackground(() -> kirimSuratKontrolWA(false));
        } else if (aksi.equals("Kirim Surat Kontrol WA Password")) {
            runBackground(() -> kirimSuratKontrolWA(true));
        } else if (aksi.equals("Reminder Terjadwal")) {
            runBackground(() -> kirimReminderTerjadwal());
        } else if (aksi.equals("Reminder Kirim Sekarang")) {
            runBackground(() -> kirimReminderSekarang());
        }
    }// GEN-LAST:event_BtnKirimGOWaActionPerformed

    private void kirimSuratKontrolWA(boolean pakaiPassword) {
        kirimSuratKontrolWA(pakaiPassword, tbObat.getSelectedRow(), TNoRM.getText(), TPasien.getText(),
                TanggalPeriksa.getSelectedItem(), TanggalSurat.getSelectedItem());
    }

    private void kirimSuratKontrolWA(boolean pakaiPassword, int selectedRow, String norm, String namaPasien,
            Object tglPeriksa, Object tglSurat) {
        try {
            if (tabMode.getRowCount() == 0) {
                notifInfo("Maaf, data sudah habis...!!!!");
                TanggalSurat.requestFocus();
                return;
            }

            if (namaPasien.trim().equals("")) {
                notifInfo("Maaf, pilih dulu data pasien.");
                return;
            }

            if (selectedRow == -1) {
                notifInfo("Maaf, pilih dulu data pada tabel.");
                return;
            }
            ...
            param.put("sipdokter", Sequel.cariIsi(
                    "select dokter.no_ijn_praktek from dokter "
                            + "inner join skdp_bpjs on dokter.kd_dokter = skdp_bpjs.kd_dokter "
                            + "where skdp_bpjs.no_rkm_medis=?",
                    norm));
            ...
            finger = Sequel.cariIsi(
                    "select sha1(sidikjari.sidikjari) from sidikjari "
                            ...
                            + "where pegawai.nik=?",
                    tabMode.getValueAt(selectedRow, 13).toString());

            String tanggal = tabMode.getValueAt(selectedRow, 10).toString().substring(0, 10);
            ...
            Sequel.menyimpan("temporary_booking_registrasi", "'0','"
                    + tabMode.getValueAt(selectedRow, 0).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 1).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 2).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 3).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 4).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 5).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 6).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 7).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 8).toString() + "','"
                    + tglPeriksa + "','"
                    + tglSurat + "','"
                    + tabMode.getValueAt(selectedRow, 11).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 12).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 13).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 14).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 15).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 16).toString() + "','"
                    + tabMode.getValueAt(selectedRow, 17).toString()
                    + "','','','','','','','','','','','','','','','','','','',''",
                    "Surat Kotrol");

            param.put("umur", Sequel.cariIsi(
                    "select pasien.umur from pasien where no_rkm_medis=?",
                    norm));

            Valid.MyReportPDF(
                    "rptSuratKontrolRSPK.jasper",
                    "report",
                    "::[ Surat Kontrol ]::",
                    param);
            ...
            System.out.println("Gagal kirim Surat Kontrol WA : " + e);
            notifError("Gagal kirim Surat Kontrol WA:\n" + e.getMessage());
        } finally {
    ...
    private void BtnCariDataActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnCariDataActionPerformed
        ...
        String diagnosa = batasiPanjangTeks(ambilDiagnosaTerakhirPasien(), 50);
        String keluhan = batasiPanjangTeks(ambilKeluhanTerakhirPasien(), 50);

        boolean adaDiagnosa = !isKosong(diagnosa);
        boolean adaKeluhan = !isKosong(keluhan);
        ...
        if (adaKeluhan) {
            Alasan1.setText(keluhan);
        }

        if (!adaDiagnosa && !adaKeluhan) {
            JOptionPane.showMessageDialog(null, "Maaf, diagnosa dan keluhan pasien tidak ditemukan...!!!!");
            Diagnosa.requestFocus();
            return;
        }

        if (!adaDiagnosa) {
            JOptionPane.showMessageDialog(null, "Diagnosa pasien tidak ditemukan, keluhan berhasil diisikan.");
            Alasan1.requestFocus();
            return;
        }

        if (!adaKeluhan) {
            JOptionPane.showMessageDialog(null, "Keluhan pasien tidak ditemukan, diagnosa berhasil diisikan.");
            Diagnosa.requestFocus();
            return;
        }
    ...
    public void tampil() {
        ...
        String sql = "SELECT skdp_bpjs.tahun, skdp_bpjs.no_rkm_medis, pasien.nm_pasien, "
    ...
    private void isBooking() {
        if (Sequel.menyimpantf("skdp_bpjs", "?,?,?,?,?,?,?,?,?,?,?,?,?", "Tahun dan nomor surat", 13, new String[] {
                TanggalPeriksa.getSelectedItem().toString().substring(6, 10), TNoRM.getText(), Diagnosa.getText(),
                Terapi.getText(),
                Alasan1.getText(), Alasan2.getText(), Rtl1.getText(), Rtl2.getText(),
                Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + " "
                        + TanggalPeriksa.getSelectedItem().toString().substring(11, 19),
            ...
            if (JADIKANBOOKINGSURATKONTROL.equals("yes")) {
                Sequel.menyimpan2("booking_registrasi", "?,?,?,?,?,?,?,?,?,?,?", "Pasien dan Tanggal", 11,
                        new String[] {
                                ...
                                KdPoli.getText(), NoReg.getText(),
                                Sequel.cariIsi(
                                        "select pasien.kd_pj from pasien where pasien.no_rkm_medis=?", TNoRM.getText()),
                                "0",
                                Valid.SetTgl(TanggalPeriksa.getSelectedItem() + "") + " "
                                        + TanggalPeriksa.getSelectedItem().toString().substring(11, 19),
                                "belum"
            ...
            tabMode.addRow(new Object[] {
                    TanggalPeriksa.getSelectedItem().toString().substring(6, 10), TNoRM.getText(), TPasien.getText(),
                    Diagnosa.getText(), Terapi.getText(), Alasan1.getText(), Alasan2.getText(),
            ...
            int lastRow = tabMode.getRowCount() - 1;
            ...
            Object tglPeriksa = TanggalPeriksa.getSelectedItem();
            Object tglSurat = TanggalSurat.getSelectedItem();

            emptTeks();
            LCount.setText("" + tabMode.getRowCount());

            runBackground(() -> {
                kirimSuratKontrolWA(false, lastRow, norm, namaPasien, tglPeriksa, tglSurat);
                kirimReminderTerjadwal(norm, namaPasien, namaPoli, namaDokter, kdDokter, tglPeriksa);
            });
        }
    }
    ...
    private void kirimReminderTerjadwal() {
        kirimReminderTerjadwal(TNoRM.getText(), TPasien.getText(), NmPoli.getText(), NmDokter.getText(),
                KdDokter.getText(), TanggalPeriksa.getSelectedItem());
    }
    ...
    private void kirimReminderTerjadwal(String norm, String namaPasien, String namaPoli, String namaDokter,
        ...
        try {
            ...
            LocalDate tglKontrol = LocalDate.parse(
                    Valid.SetTgl(tglPeriksa.toString()));
    ...
    private String ambilJamPraktekDokter() {
        return ambilJamPraktekDokter(TanggalPeriksa.getSelectedItem(), KdDokter.getText());
    }

    private String ambilJamPraktekDokter(Object tglPeriksa, String kdDokter) {
        String jamPraktek = "";
    ...
    private String ambilDiagnosaTerakhirPasien() {
        ...
        String sqlRalan = "select penyakit.nm_penyakit "
        ...
        String diagnosa = Sequel.cariIsi(sqlRalan, noRm);

        if (isKosong(diagnosa)) {
            String sqlSemua = "select penyakit.nm_penyakit "
                    + "from diagnosa_pasien "
                    + "inner join reg_periksa on diagnosa_pasien.no_rawat=reg_periksa.no_rawat "
                    + "inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit "
                    + "where reg_periksa.no_rkm_medis=? "
            ...
            diagnosa = Sequel.cariIsi(sqlSemua, noRm);
        }

        return amanTrim(diagnosa);
    }

    private String ambilKeluhanTerakhirPasien() {
        String noRm = TNoRM.getText();

        String sql = "select pemeriksaan_ralan.keluhan "
                + "from pemeriksaan_ralan "
                + "inner join reg_periksa on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "
                + "where reg_periksa.no_rkm_medis=? "
                + "and ifnull(pemeriksaan_ralan.keluhan,'')<>'' "
                + "order by pemeriksaan_ralan.tgl_perawatan desc, pemeriksaan_ralan.jam_rawat desc "
                + "limit 1";

        String keluhan = Sequel.cariIsi(sql, noRm);

        return amanTrim(keluhan);
    }

    private String batasiPanjangTeks(String teks, int panjangMaksimal) {
        teks = amanTrim(teks);

        if (panjangMaksimal <= 0) {
            return "";
        }
    ...
    private String amanTrim(String teks) {
        return teks == null ? "" : teks.trim();
    }
    ...
    private void notifError(String pesan) {
        SwingUtilities.invokeLater(() -> {
            JOptionPane.showMessageDialog(this, pesan, "Gagal", JOptionPane.ERROR_MESSAGE);
        });
    }

    private String ambilNoHpPasien() {
        return Sequel.cariIsi(
                "select no_tlp from pasien where no_rkm_medis=?",
                TNoRM.getText());
    }

    private void logStatusKirim(String norm, String nohp) {
        try {
            Connection koneksiWa = fungsi.koneksiDBWa.condb();
            PreparedStatement psWa = koneksiWa.prepareStatement(
                    "INSERT INTO wa_outbox (NOWA, PESAN, TANGGAL_JAM, STATUS, SOURCE, SENDER, TYPE) VALUES (?, ?, ?, ?, ?, ?, ?)");

            String cleanPhone = nohp.replaceAll("[^0-9]", "");
            ...
            String formattedPhone = cleanPhone + "@c.us";

            psWa.setString(1, formattedPhone);
            psWa.setString(2, "Surat Kontrol Terkirim untuk pasien " + norm);
            psWa.setString(3, new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
            psWa.setString(4, "TERKIRIM");
            psWa.setString(5, "KONTROL_WA");
            psWa.setString(6, "GOWA");
            psWa.setString(7, "TEXT");
            psWa.executeUpdate();
            psWa.close();
        } catch (Exception e) {
            System.out.println("Gagal logStatusKirim: " + e);
        }
    }

    private String checkStatusKirim(String nohp) {
        if (nohp == null || nohp.trim().equals("")) {
            return "tidak";
        }
        String status = "tidak";
        try {
            Connection koneksiWa = fungsi.koneksiDBWa.condb();
            PreparedStatement psWa = koneksiWa.prepareStatement(
                    "SELECT count(*) FROM wa_outbox WHERE NOWA = ? AND SOURCE = 'KONTROL_WA'");
            ...
            psWa.setString(1, formattedPhone);
            ResultSet rsWa = psWa.executeQuery();
            if (rsWa.next() && rsWa.getInt(1) > 0) {
                status = "ya";
            }
            rsWa.close();
            psWa.close();
        } catch (Exception e) {
            System.out.println("Error checkStatusKirim: " + e);
        }
        return status;
    }

    private String checkStatusJadwal(String nohp) {
        if (nohp == null || nohp.trim().equals("")) {
            return "tidak";
        }
        String status = "tidak";
        try {
            Connection koneksiWa = fungsi.koneksiDBWa.condb();
            PreparedStatement psWa = koneksiWa.prepareStatement(
                    "SELECT count(*) FROM wa_outbox WHERE NOWA = ? AND SOURCE = 'KONTROL'");
            ...
            System.out.println("Error checkStatusJadwal: " + e);
        }
        return status;
    }
}
