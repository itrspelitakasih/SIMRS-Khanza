 ...
 * @author salimmulyana
 */
public final class SuratKeteranganDokter extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public SuratKeteranganDokter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakSuratSakit5.setText("Surat Sakit RSPK");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Dokter ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-05-2026" }));
        ...
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-05-2026" }));
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Surat Keterangan Dokter ]::");
    ...
    private void MnCetakSuratSakit5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit5ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            param.put("finger","https://apps.rspelitakasih.id/verifyPDF/?id="+EnkripsiAES.encrypt("{'x':'sks','t':'"+NoSurat.getText()+"'}"));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            SuratKeteranganDokter dialog = new SuratKeteranganDokter(new javax.swing.JFrame(), true);
...
//        NoSurat.requestFocus();
    ...
    private void nomorSurat() {
        try {
            ...
            String tanggalStr = Valid.SetTgl(TanggalAwal.getSelectedItem().toString());
            ...
            String formatPattern = "/SKS/RJ-RSPK/" + bln_romawi + "/" + tahunStr;
            ...
            NoSurat.setText("001/SKS/RJ-RSPK/VIII/2025");
        }
    }
