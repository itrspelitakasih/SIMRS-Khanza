...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakLab.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab1.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab2.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab3.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab4.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab5.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab6.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab7.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab8.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab9.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab10.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab22.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnPDFLab.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab12.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab13.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab14.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab15.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab16.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab17.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab18.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab19.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab20.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab21.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnCetakHasilLab23.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnUbah.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnUbah1.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        MnSaranKesan.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Kesan & Saran ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Scroll4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 253)), "Kesan :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Scroll3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 253)), "Saran :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Pemeriksaan Laboratorium Patologi Klinis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnHapus.setPreferredSize(new java.awt.Dimension(24, 24));
        ...
        BtnPrint.setPreferredSize(new java.awt.Dimension(24, 24));
        ...
        BtnKeluar.setPreferredSize(new java.awt.Dimension(24, 24));
    ...
    private void BtnKirimGOWaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimGOWaActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            try {
                ps4 = koneksi.prepareStatement(
                    "select periksa_lab.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"
                    + "periksa_lab.dokter_perujuk,periksa_lab.kd_dokter,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,dokter.nm_dokter,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as lahir,pasien.no_tlp "
                    + "from periksa_lab inner join reg_periksa inner join pasien inner join petugas  inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "
                    + "on periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_lab.nip=petugas.nip and periksa_lab.kd_dokter=dokter.kd_dokter "
                    + "and pasien.kd_kel=kelurahan.kd_kel and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab where periksa_lab.kategori='PK' and "
                    + "periksa_lab.tgl_periksa=? and periksa_lab.jam=? and periksa_lab.no_rawat=? group by concat(periksa_lab.no_rawat,periksa_lab.tgl_periksa,periksa_lab.jam)");
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String tanggal = rs.getString("tgl_periksa");
                        ...
                        param.put("finger", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + rs.getString("nm_dokter") + "\nID " + (finger.equals("") ? rs.getString("kd_dokter") : finger) + "\n" + rs.getString("tgl_periksa"));
                        finger = Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", rs.getString("nip"));
                        //param.put("finger2","https://apps.rspelitakasih.id/verifyPDF/?id="+EnkripsiAES.encrypt("{'x':'lab','t':'" + kdmem + "'}"));
                        param.put("finger2", "Dikeluarkan di " + akses.getnamars() + ", Kabupaten/Kota " + akses.getkabupatenrs() + "\nDitandatangani secara elektronik oleh " + rs.getString("nama") + "\nID " + (finger.equals("") ? rs.getString("nip") : finger) + "\n" + rs.getString("tgl_periksa"));

                        Sequel.queryu("delete from temporary_lab");
                        System.out.println("temporary_lab dihapus");
                        ps2 = koneksi.prepareStatement(
                            "select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,periksa_lab.biaya from periksa_lab inner join jns_perawatan_lab "
                            + "on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw where periksa_lab.kategori='PK' and periksa_lab.no_rawat=? and periksa_lab.tgl_periksa=? "
                            + "and periksa_lab.jam=?");
                        try {
                            ...
                            while (rs2.next()) {
                                ...
                                try {
                                    ...
                                    ps3.setString(4, rs.getString("jam"));
                                    rs3 = ps3.executeQuery();
                                    System.out.println("Isi temporary_lab selesai dimasukkan");
                                    while (rs3.next()) {
                                        Sequel.menyimpan("temporary_lab", "'" + i + "','  " + rs3.getString("Pemeriksaan") + "','" + rs3.getString("nilai").replaceAll("'", "`") + "','" + rs3.getString("satuan")
                                            + "','" + rs3.getString("nilai_rujukan") + "','" + rs3.getString("keterangan") + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''", "Data User");
                                        i++;
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                param.put("tanggalpermintaan", rspermintaan.getString("tgl_permintaan"));
                                param.put("jampermintaan", rspermintaan.getString("jam_permintaan"));
                                Valid.MyReportPDF("rptPeriksaLab2RSPK.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                            }

                            // ================= SIMPAN NAMA FILE =================

                            String pesan = "Halo *" + rs.getString("nm_pasien") + "* 👋\n\n"
